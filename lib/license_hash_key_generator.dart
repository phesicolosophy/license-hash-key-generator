...
class LicenseHashKeyGenerator extends StatefulWidget {
  const LicenseHashKeyGenerator({super.key});

  @override
  LicenseHashKeyGeneratorState createState() => LicenseHashKeyGeneratorState();
}

class LicenseHashKeyGeneratorState extends State<LicenseHashKeyGenerator> {
